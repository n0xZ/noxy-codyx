...
<header class="p-6 ">
	...
	>
		<h1>
			<a
				href="/"
				class="no-underline list-upper-roman hover:text-rose-500 duration-100 ease-in-out font-semibold"
				>Codyx</a
			>
		</h1>
...
<section
	class="min-h-screen h-full flex flex-col justify-center items-center space-y-5 "
>
	...
	<a href="/login" class="px-6 py-4 outline-none bg-rose-500 rounded-lg  text-gray-50"
		>Comenzar ya</a
	>
</section>
